...
@section('content-body')
    <div class="row card-dashboard">
        <div class="col-lg-3 col-md-6">
            <a href="{{ route('user.clients') }}" class="text-gray">
        ...
        <div class="col-lg-3 col-md-6 mt-4 mt-md-0">
            <a href="{{ route('admin.order') }}" class="text-gray">
        ...
        <div class="col-lg-3 col-md-6 mt-4 mt-lg-0">
            <a href="{{ route('admin.reviews') }}" class="text-gray">
        ...
        <div class="col-lg-3 col-md-6 mt-4 mt-lg-0">
            <a href="{{ route('admin.blogs') }}" class="text-gray">
