...
<div class="row">
    <div class="col-lg-6">
        <div class="card">
            ...
            <div class="card__body">
                ...
                <div class="d-flex justify-content-between py-1">
                    <label>Country:</label>
                    <span>{{ Arr::get($countries, $billing->country) }}</span>
                </div>
                <div class="d-flex justify-content-between py-1">
                    <label>State:</label>
    ...
    <div class="col-lg-6 mt-5">
        <div class="card">
            ...
            <div class="card__body">
                ...
                @if($billing->service === Billing::TEXT || $billing->service === Billing::VIDEO)
                    <div class="d-flex justify-content-between py-1">
                    ...
                    <div class="d-flex justify-content-between py-1">
                        ...
                        <span>
                            {{$brief->artist_accent ? Arr::get($countries, $brief->artist_accent) : '---'}}
                        </span>
                    </div>
                    <div class="d-flex justify-content-between py-1">
    ...
    @if($billing->service === Billing::LOGO)
